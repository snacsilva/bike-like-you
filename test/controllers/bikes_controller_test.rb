...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create bike' do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { vacancy_id: @bike.vacancy_id, with_problem: @bike.with_problem } }
    end
  ...
  test 'should update bike' do
    patch bike_url(@bike), params: { bike: { vacancy_id: @bike.vacancy_id, with_problem: @bike.with_problem } }
